        ...
        binding.btnConsultar.setOnClickListener {
            ...
            if(tabla_creada){
                if(!binding.titCol.text.isNullOrBlank()){
                    ...
                    val fila = bd.rawQuery("select nombre,apellidos from Alumnos where codigo=${Integer.parseInt(binding.titCol.text.toString())}", null)
                    if (fila.moveToFirst()) {
                    ...
                    Toast.makeText(this,"NO HAS INTRODUCIDO UN CODIGO DE ALUMNO",Toast.LENGTH_SHORT).show()
                }
            }else{
